...
<section>
 ...
 <div class="form-group">
    ...
    <select class="form-control" id="exampleInputRole" name="usrrole" aria-describedby="roleHelp">
						...
						<option value="3" <?php echo ($userdetails['user_group_id'] == '3')?'selected="Selected"':'';?>>PG Admin </option>
						<option value="4" <?php echo ($userdetails['user_group_id'] == '4')?'selected="Selected"':'';?>>Member </option>
