<section>
	<div class="container-fluid">
		...
		<?php //print_r($pgdetail);
			...
			<div class="col-md-2">
				<div class="sidebar">
					<ul>
						...
						<li><a href="<?php echo base_url(); ?>admin-manager?atype=producergroupdetails" class="active">PG Panel</a></li>
			...
			<div class="col-md-10">
				<div class="content content-box">
					<div class="col-md-12 text-right mb-1 pt-3 pb-3">
						  ...
						  <button class="btn btn-primary" type="button" name="pglist" value="PG List" onclick="window.location.href='<?php echo base_url() ?>admin-manager?atype=producergroupdetails'">PG List</button>
						
						<button class="btn btn-success" type="button" name="addpg" value="Add PG" onclick="window.location.href='<?php echo base_url() ?>form-filling'">Add PG</button>
					</div>
		   ...
		   <h6 class="m-0">Location</h6>
			  ...
			  <div class="form-row">
				  ...
				  <label for="validationTooltip03"><b>District</b></label>
					...
					<option  value="">Choose...</option>
					  <?php foreach($districts as $district){ ?>
						...
						<option value="<?php echo $district['district']; ?>"  <?php  if($districtname == $district['district']) {  echo 'selected="selected"'; }  ?>><?php echo ucfirst($district['district']); ?></option>
				...
				<div class="col-md-2 mb-3">
				  ...
				  <select class="custom-select" id="blocknames" name="blockname">
					<option value="">Choose...</option>
					<?php  if($blockname == true) {  echo ' <option value="'.$blockname.'"  selected="selected">'.ucfirst($blockname).'</option>'; }  ?>
				  </select>
				  <div class="invalid-tooltip">
					Please select a valid Block.
				  </div>
			...
			<div class="col-md-3 mb-3">
				  ...
				  <option value="">Choose...</option>
					<?php if($grampanchayatname == true) {  echo ' <option value="'.$grampanchayatname.'"  selected="selected">'.ucfirst($grampanchayatname).'</option>'; }  ?>
				  </select>
				...
				<div class="col-md-3 mb-3">
				  ...
				  <select name="villagename[]" class="custom-select" id="villagename" multiple>
					<option value="">Choose...</option>
					<?php  if($villagename == true) { $villages = explode(',',$villagename);
		  ...
		  <tbody>
		   ...
		   <h6 class="m-0"> PG promoted under</h6>
		    ...
		    <div class="col-md-12 text-right mb-1"><br/>
				...
				<input type="hidden" name="pgid" value="<?php echo ($this->session->userdata('pgid') == true)?$this->session->userdata('pgid'):''; ?>" />		
		   ...
		   <?php //print_r($userdetails); ?>
			  ...
			  <div class="col-md-1">
			   <a  class="btn-sm btn-info" title="Add Task" onclick="addBankFunction()" style="color:#fff;"><i class="fa fa-plus"></i></a>
			   </div>
			   </div>
			  ...
			  foreach($getbankdetails as $getbankdetail){ ?>
				  ...
				  <td><input class="form-control" type="text" name="ifsc[]" value="<?php echo $getbankdetail['IFSC'];?>" placeholder="IFSC"></td>
				  <td><input class="form-control" type="text" name="branchname[]" value="<?php echo $getbankdetail['branchname'];?>" placeholder="Branch Name"></td>
				  <td><input class="form-control" type="number" minlength="12" maxlength="12" name="accountno[]" value="<?php echo $getbankdetail['accountno'];?>" placeholder="Account No.">
				   <input type="hidden" name="pgbdid[]"  value='<?php echo $getbankdetail['id'];?>' />
			...
			<br/>
		      ...
		      <div class="col-md-12 row">
			   ...
			   <div class="form-group row">
				...
				<div class="col-md-8">
				  <select class="form-control form-control" name="categoryname" id="categoryname">
				 ...
				 <?php foreach(array_filter($categories) as $categoryname){ ?>
				  <option value="<?php echo $categoryname['category']; ?>" <?php if($category == $categoryname['category']){ echo 'selected="selected"'; } ?>><?php echo ucfirst($categoryname['category']) ?></option>
			   ...
			   <div class="form-group row">
				  ...
				  <select class="form-control form-control" name="commoditynewname" id="commoditynewname">
		   ...
		   <?php //print_r($userdetails); ?>
			...
			<div class="col-md-3 p-3  card"  style="background-color: #e1e1e1;"> 
				<b>Contact Person</b>
			   <a href="tel:+91 9990008970" ><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<?php echo $president_name; ?></a>
			</div>
			</div>
			    ...
			    <div class="col-md-6"  id="udyogsakhipgva">		
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="usaa[]" <?php echo (stristr($VAAUS,'drying') == true ?'checked':''); ?> value="drying" id="gridCheck1">
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="usaa[]" value="grading" <?php echo (stristr($VAAUS,'grading') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Grading
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="usaa[]" <?php echo (stristr($VAAUS,'sorting') == true ?'checked':''); ?> value="sorting" id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Sorting
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="usaa[]" <?php echo (stristr($VAAUS,'processing') == true ?'checked':''); ?> value="processing" id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Processing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="usaa[]" <?php echo (stristr($VAAUS,'storing') == true ?'checked':''); ?> value="storing"  id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Storing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="usaa[]" <?php echo (stristr($VAAUS,'packaging') == true ?'checked':''); ?> value="packaging"  id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Packaging
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="usaa[]" <?php echo (stristr($VAAUS,'labelling') == true ?'checked':''); ?> value="labelling"  id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Labelling
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="usaa[]" <?php echo (stristr($VAAUS,'weighing') == true ?'checked':''); ?> value="weighing"  id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Weighing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="usaa[]" <?php echo (stristr($VAAUS,'collective_marketing') == true ?'checked':''); ?> value="collective_marketing" id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalactnoa" type="checkbox" id="gridCheck1" value='nota' <?php echo (stristr($VAAUS,'nota') == true ?'checked':''); ?>  onclick="additionalactnota()">
					<label class="form-check-label" for="gridCheck1">
					 None of The Above
					</label>
				  </div>				  
				 ...
				 <div class="col-md-6"  id="pashusakhipgga"> 
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="drying" <?php echo (stristr($VAAPS,'drying') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Drying
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="grading" <?php echo (stristr($VAAPS,'grading') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Grading
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="sorting" <?php echo (stristr($VAAPS,'sorting') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Sorting
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="processing" <?php echo (stristr($VAAPS,'processing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Processing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="storing" <?php echo (stristr($VAAPS,'storing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Storing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="packaging" <?php echo (stristr($VAAPS,'packaging') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Packaging
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="labelling" <?php echo (stristr($VAAPS,'labelling') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Labelling
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="weighing" <?php echo (stristr($VAAPS,'weighing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Weighing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox" name="psaa[]" value="collective_marketing" <?php echo (stristr($VAAPS,'collective_marketing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Collective marketing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalactnoa" type="checkbox" name="psaa[]" id="gridCheck1" value="nota" <?php echo (stristr($VAAPS,'nota') == true ?'checked':''); ?> onclick="additionalactnota()">
					<label class="form-check-label" for="gridCheck1">
					 None of The Above
					</label>
				  </div>				  
				...
				<div class="row col-md-12"> 
				 <div class="col-md-6"  id="krishisakhipgga">	<br/>	
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="drying" <?php echo (stristr($VAAKS,'drying') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Drying
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="grading" <?php echo (stristr($VAAKS,'grading') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Grading
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="sorting" <?php echo (stristr($VAAKS,'sorting') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Sorting
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="processing" <?php echo (stristr($VAAKS,'processing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Processing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="storing"  <?php echo (stristr($VAAKS,'storing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Storing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="packaging" <?php echo (stristr($VAAKS,'packaging') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Packaging
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]"  value="labelling" <?php echo (stristr($VAAKS,'labelling') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Labelling
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="weighing" <?php echo (stristr($VAAKS,'weighing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Weighing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="checkbox"  name="ksaa[]" value="collective_marketing" <?php echo (stristr($VAAKS,'collective_marketing') == true ?'checked':''); ?> id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Collective marketing
					</label>
				  </div>
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalactnoa" type="checkbox" id="gridCheck1" value="nota"  <?php echo (stristr($VAAKS,'nota') == true ?'checked':''); ?> onclick="additionalactnota()">
					<label class="form-check-label" for="gridCheck1">
					 None of The Above
					</label>
				  </div>				  
      ...
      <div class="row  col-md-12 mt-2">
      <div>
        <label class="btn btn-<?php echo ($USname == '')?'primary':'success'; ?>" id="uslabel" style="margin-right: 14px;font-weight: 500;"><input type="checkbox" id="uscheckbox"  name="uspgtype[]" onclick="pgaddionalresponse('uscheckbox','udyogsakhipg','uslabel')" value="udyogsakhipg" <?php echo ($USname == '')?'':'checked'; ?> >&nbsp;Udyog Sakhi </label>
        <label class="btn btn-<?php echo ($PSname == '')?'primary':'success'; ?>"  id="pslabel"  style="margin-right: 14px;font-weight: 500;"><input type="checkbox" id="pscheckbox" name="uspgtype[]" onclick="pgaddionalresponse('pscheckbox','pashusakhipg','pslabel')" value="pashusakhipg" <?php echo ($PSname == '')?'':'checked'; ?>>&nbsp;Pashu Sakhi</label>
        <label class="btn btn-<?php echo ($KSname == '')?'primary':'success'; ?>"  id="kslabel"   style="margin-right: 14px;font-weight: 500;"><input type="checkbox" id="kscheckbox" name="uspgtype[]" onclick="pgaddionalresponse('kscheckbox','krishisakhipg','kslabel')" value="krishisakhipg" <?php echo ($KSname == '')?'':'checked'; ?>>&nbsp;Krishi Sakhi</label>
			 ...
			 <div class="red box col-md-5 px-0 ">Name of Udyog Sakhi Associated with the PG</div>
			   ...
			   <label for="inputvallueaadion" class="col-form-label col-md-5">No. of Village Covered by PG</label>
			     <div class="form-group col-md-7 px-0">
					...
					<?php for($i=0; $i<=15; $i++){ ?>
					<option value="<?php echo $i; ?>"  <?php echo ($USnovillage == $i)?'selected="selected"':''; ?>><?php echo $i; ?></option>
					<?php } ?>
				  </select>
				 </div>
			   </div>
			   ...
			   <label for="inputvallueaadion" class="col-form-label col-md-5">No. of Member Associated with PG</label>
			      <div class="form-group col-md-2 px-0">
					...
					<input type="number" min='0' name="usnomember" value="<?php echo ($USnomember == '')?'0':$USnomember; ?>"   class="form-control col-md-7">
				  </div>
			   </div>
			 ...
			 <div class="red box col-md-5 px-0">Name of Pashu Sakhi Associated with the PG</div>
				...
				<div class="col-md-2">
				  ...
				  <label class="form-check-label" for="exampleRadios1">
				   ...
				   <div class="form-group col-md-11 px-0">
					<input type="text" name="pgpsname" class='txbx1 form-control' value="<?php echo $PSname ; ?>" <?php echo ($PSname == '')?'hidden':''; ?>/>  
					</div>
				  </div>
				</div>
			   ...
			   <label for="inputvallueaadion" class="col-form-label col-md-5">No. of Member Associated with PG</label>
			      <div class="form-group col-md-2 px-0">
					...
					<input type="number" min="0" name="psnomember" value="<?php echo ($PSnomember == '')?'0':$PSnomember; ?>"   class="form-control">
				  </div>
			   </div>
			...
			<div id="krishisakhipg" style="display:<?php echo ($KSname == '')?'none':'block'; ?>">
			 ...
			 <div class="red box col-md-5 px-0">Name of Krishi Sakhi Associated with the PG</div>
				  ...
				  <label class="form-check-label" for="exampleRadios1">
				   ...
				   <div class="form-group col-md-11 px-0">
					<input type="text" class='txbx2 form-control' name="pgksname" value="<?php echo $KSname ; ?>" <?php echo ($KSname == '')?'hidden':''; ?> />  
					</div>
				  </div>
				</div>
		   ...
		   <div class="form-group row">
			   <label for="inputvallueaadion" class="col-form-label col-md-5">No. of Member Associated with PG</label>
			      <div class="form-group col-md-2 px-0">
					...
					<input type="number" min="0" name="ksnomember" class="form-control"  value="<?php echo ($KSnomember == '')?'0':$KSnomember; ?>" >
				  </div>
			   </div>	  
			</form>			
			</div> 
			  ...
			  <tbody>
				...
				<tr>
				 ...
				 <input type="text" class="form-control col-md-4"    ></p></td> </td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="bor[]" onchange='ChheckValue(this.value);'>
         ...
         <div class="col-md-12">
			  ...
			  <tbody>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Irrigation and fertigation management</td>
				  ...
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					...
					<option value="" <?php echo (stristr($TLAgriculture,'Irrigation and fertigation management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Cutivation of harvest & post-harvest management & value addition</td>
				   <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					<option value="Cutivation of harvest & post-harvest management & value addition" <?php echo (stristr($TLAgriculture,'Cutivation of harvest & post-harvest management & value addition') == true ?'selected="selected"':''); ?>>Yes</option>
   ...
   element.style.display='none';
			...
			<?php } ?>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Irrigation and fertigation management</td>
				  ...
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					...
					<option value="" <?php echo (stristr($TLHorticulture,'Irrigation and fertigation management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 <td style="font-weight:500;">5.</td>				 
				 <!-- <td style="font-weight:500;">Post Harvest Management</td> -->
				 <td style="font-weight:500;">Cultivation of harvest & post-harvest management & value addition</td>
				   <td class="col-md-2 px-2 text-center">
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					<option value="Cultivation of harvest & post-harvest management & value addition" <?php echo (stristr($TLHorticulture,'Cultivation of harvest & post-harvest management & value addition') == true ?'selected="selected"':''); ?>>Yes</option>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Package and storage of fresh fruits/vegetables</td>
				  ...
				  <select  name="TLHorticulture[]" class="form-control  col-md-7">
					...
					<option  value="" <?php echo (stristr($TLHorticulture,'Package and storage of fresh fruits/vegetables') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Poly House and Green House cultivation management</td>
				  ...
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					...
					<option value="" <?php echo (stristr($TLHorticulture,'Poly House and Green House cultivation management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
 ...
 if(val=='yes')
   ...
   element.style.display='none';
			 ...
			 <?php if($this->input->get('tltype') == true && $this->input->get('tltype') == 'fishery'){ ?>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Pond Preparation and Renovation</td>
				   <td class="col-md-2 px-2 text-center">
					<select name="TLFishery[]" class="form-control  col-md-7">
					<option value="Pre-Stocking Management" <?php echo (stristr($TLFishery,'Pond Preparation and Renovation') == true ?'selected="selected"':''); ?>>Yes</option>
       ...
       minlength="4" maxlength="8" size="10" class="form-control"></div>
				 ...
				 <input type="text" class="form-control col-md-4"    ></p></td> </td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLFishery[]"  onchange='CheckValuess(this.value);'>
			 ...
			 <?php if($this->input->get('tltype') == true && $this->input->get('tltype') == 'sericulture'){ ?>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Cultivation techniques, Nutrition and disease Management</td>
				   <td class="col-md-2 px-2 text-center">
				 <select name="TLSericulture[]" class="form-control  col-md-7">
					<option value="Cultivation techniques, Nutrition and disease Management" <?php echo (stristr($TLSericulture,'Cultivation techniques, Nutrition and disease Management') == true ?'selected="selected"':''); ?>>Yes</option>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Young age and Late age worm rearing and Management</td>
				   <td class="col-md-2 px-2 text-center">
					...
					<option value="" <?php echo (stristr($TLSericulture,'Young age and Late age worm rearing and Management') == false ?'selected="selected"':''); ?> >No</option>
				    </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Seed cocoon production and loose egg preservation Management</td>
				   <td class="col-md-2 px-2 text-center">
					<select name="TLSericulture[]" class="form-control  col-md-7">
					<option value="Seed cocoon production and loose egg preservation Management" <?php echo (stristr($TLSericulture,'Seed cocoon production and loose egg preservation Management') == true ?'selected="selected"':''); ?>>Yes</option>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Drudgery reduction through ergonomically sound appliances / tools</td>
				   <td class="col-md-2 px-2 text-center">
					<select name="TLSericulture[]" class="form-control  col-md-7">
					<option value="Drudgery reduction through ergonomically sound appliances" <?php echo (stristr($TLSericulture,'Drudgery reduction through ergonomically sound appliances') == true ?'selected="selected"':''); ?>>Yes</option>
				...
				<tr>
				 ...
				 <input type="text" class="form-control col-md-4"    ></p></td> </td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7"  name="TLSericulture[]"  onchange='CheckValuessss(this.value);'>
			 ...
			 <?php } ?>
				...
				<tr>
				 ...
				 <div class="col-md-4">
				 <input type="text" name="TLOthers[]" value="<?php echo isset($TLOther[0])?$TLOther[0]:''; ?>" class="form-control"></td>
				...
				<tr>
				 ...
				 <input type="text" name="TLOthers[]" value="<?php echo isset($TLOther[1])?$TLOther[1]:''; ?>" class="form-control"></td>
				   
				</tr>
				<tr>
				 <td style="font-weight:500;">3.</td>				 
				 <td style="font-weight:500;"><div class="col-md-4">
				 <input type="text" name="TLOthers[]" value="<?php echo isset($TLOther[2])?$TLOther[2]:''; ?>" class="form-control"></td>
				...
				<tr>
				 <td style="font-weight:500;">4.</td>				 
				 <td style="font-weight:500;"><div class="col-md-4">
				 <input type="text" name="TLOthers[]" value="<?php echo isset($TLOther[3])?$TLOther[3]:''; ?>" class="form-control"></td>
				...
				<tr>
				 <td style="font-weight:500;">5.</td>				 
				 <td style="font-weight:500;"><div class="col-md-4">
				 <input type="text" name="TLOthers[]" value="<?php echo isset($TLOther[4])?$TLOther[4]:''; ?>" class="form-control"></td>
		   ...
		   <form class="row pr-4 pl-4" method="post">
			  ...
			  <div class="row">
			   ...
			   <div class="col-md-1">
			   <a  class="btn-sm btn-info" title="Add Support Recieved" onclick="addSupportRecieveFunction()" style="color:#fff;"><i class="fa fa-plus"></i></a>
			   </div>
			   </div>
			...
			<table class="table p-3 table-bordered table-striped">
			  ...
			  <tbody>
				<tr>
				  ...
				  <td class="col-md-2 px-2 text-center">
				  <input class="form-control" type="number" min="0" name="SRPGamount[]" placeholder=" ">
				  </td>
				  <td class="col-md-2 px-2 text-center">
				  ...
				  <td class="col-md-2 px-2 text-center">
				  <input class="form-control" type="number" min="0"  name="SRPGtosamount[]" placeholder=" "></td>
				  <td><input class="form-control " type="date" name="SRPGdate[]" placeholder=" "></td>
			  ...
			  <div class="row">
			   <div class="col-md-11"><h6 class="m-0"> PAYMENT MODE BY PG 123</h6><br></div>			  
			   </div>			  
			  <table class="table p-3 table-bordered table-striped">
			  <thead>
				<tr>				  
			  ...
			  <tbody>				
				<tr>
				  ...
				  <td><input class="form-control" type="text" name="PMPGrp[]"  placeholder=" "></td>
				  <td><input class="form-control" type="text" name="PMPGinterest_rate[]"  placeholder=" "></td>
				  <td><input class="form-control" type="text" name="PMPGmonthlyemi[]"  placeholder=" "></td>
				  <td><input class="form-control" type="text" name="PMPGamountdue[]"  placeholder=" "></td>
				</tr>				
			  </tbody>
			</table>
			  ...
			  <tbody>
				...
				<tr>
				   <td><input class="form-control" type="number"  min="0" name="loanduration[]" ></td>
			       <td><input class="form-control" type="date" name="commencement_date[]"></td>
		   ...
		   <form class="row pr-4 pl-4" method="post">
			  ...
			  <h4 class="m-0"> Monthly Business Summary:<br><br>
			   ...
			   <div class="col-md-1">
			   <a href="#" onClick="addMonthlyBusinessSummaryFunction();" class="btn-sm btn-info" title="Add Task"><i class="fa fa-plus"></i></a>
			   </div>
			   </div>
			  ...
			  <thead>
				<tr>				  
				  <th scope="col" width="20%">Commodity Category*</th>
				  <th scope="col" width="20%">Commodity Name*</th>
				...
				<tr>
				  <td>
					<select class="form-control" name="commoditycategory[]">
						<!-- <option value="clf" <?php echo ($sr['PMPGsof'] == 'clf')?'selected="selected"':''; ?>>CLF</option> -->
						<option value="agriculture">Infrastructure</option>
				  ...
				  <td><input name="commodity[]" class="form-control" type="text" placeholder="TEXT"></td>
				  <td><input name="opstock[]" class="form-control" type="text" placeholder="In Fig">
				  <div class="row mt-2"> 
				  <div class="col-md-6"><input name="opamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
				  <div class="col-md-6"> <input name="oprate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
				  
				  </div>
				  </td>
				  <td><input name="procureqty[]" class="form-control" type="text" placeholder="In Fig">
				   <div class="row mt-2"> 
				  <div class="col-md-6"><input name="procureamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
				  <div class="col-md-6"> <input name="procurerate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
				  </div></td>
				  
				  <td><input name="procurewastageqty[]" class="form-control" type="text" placeholder="In Fig">
					<div class="row mt-2"> 
					<div class="col-md-6"><input name="procurewastageamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
					<div class="col-md-6"> <input name="procurewastagerate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
					</div>
				  </td>
			  ...
			  <tbody>
				...
				<tr>
				  <td><input name="otherexpenditureqty[]" class="form-control" type="text" placeholder="In Fig">
					<div class="row mt-2"> 
					<div class="col-md-6"><input name="otherexpenditureamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
					<div class="col-md-6"> <input name="otherexpenditurerate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
					</div>
				  </td>
				  
				  <td><input name="saleqty[]" class="form-control" type="text" placeholder="In Fig">
				  <div class="row mt-2"> 
				  <div class="col-md-6"><input name="saleamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
				  <div class="col-md-6"> <input name="salerate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
				  </div></td>
				  <td><input name="closingstockqty[]" class="form-control" type="text" placeholder="In Fig">
				   <div class="row mt-2"> 
				  <div class="col-md-6"><input name="closingstockamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
				  <div class="col-md-6"> <input name="closingstockrate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
				  </div></td>
				  
				    <td><input name="surplusqty[]" class="form-control" type="text" placeholder="In Fig">
				  <div class="row mt-2"> 
				  <div class="col-md-6"><input name="surplusamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
				  <div class="col-md-6"> <input name="surplusrate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
				  </div></td>

				  <td>
					<input name="cumulativesalesqty[]" class="form-control" type="text" placeholder="In Fig">
					<div class="row mt-2"> 
					<div class="col-md-6"><input name="cumulativesalesamount[]" class="form-control" type="number" placeholder="Amount" min="100000"/> </div>
					<div class="col-md-6"> <input name="cumulativesalesrate[]" class="form-control" type="number" placeholder="Rate" min="0"/></div>
					<input type="hidden" name="pgssavetype[]" value="add">
					</div>
				  </td>
				</tr>
		   ...
		   <form class="row pr-4 pl-4" method="post">
			...
			<input type="number" name="su_paymenttomember" value="<?php echo $su_paymenttomember; ?>" class="form-control col-md-8" min="0" id="inputname"></div></div>
			...
			<input type="number" name="su_paymentduepgmember" class="form-control col-md-8" min="0" value="<?php echo $su_paymentduepgmember; ?>" id="inputname"></div>
			...
			<div class="col-md-12">
			   ...
			   <!--div class="col-md-2">
				...
				<div class="col-md-3">
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" name="inverttopg" type="radio" id="gridCheck1" onclick="enabletxtinvertopg('inputadditionalactothers4')">
					<label class="form-check-label" for="gridCheck1">
					 Others
					</label>
					<div class="form-group col-md-2"  style="display:none;" id="inputadditionalactothers4" >
					<input type="text" class="form-control">
					</div>
				  </div>
				</div><br/>
		  ...
		  <form class="row pr-4 pl-4" method="post">
			  ...
			  <tbody>
				<tr>
				  <td><input class="form-control" name="cb_cihcb"  id="cb_cihcb"  value="<?php echo $cb_cihcb; ?>" type="text" placeholder=" "></td>
				  <td><input class="form-control" name="cb_cihbb" id="cb_cihbb"  value="<?php echo $cb_cihbb; ?>" type="text" placeholder=" "></td>				 
				  <td><input class="form-control" name="cb_total" id="cb_total"  value="<?php echo $cb_total; ?>" type="text" placeholder=" "></td>
				</tr>
			...
			<input class="form-control" type="text" name="cb_frombuyer" value="<?php echo $cb_frombuyer; ?>" placeholder=" "><br/><br/>
			<h6 class="m-0">Payment yet to be made to producers member* (in rupees)</h6><br/>
			<input class="form-control" type="text" name="cb_payproducermember" value="<?php echo $cb_payproducermember; ?>" placeholder=" "><br/><br/>
		   ...
		   <form class="row pr-4 pl-4" method="post">
			...
			<input type="text" name="finalenumerator_name" value="<?php echo $finalenumerator_name; ?>" class="form-control col-md-8" id="inputname"></div>
			
			<div class="form-group"><label for="inputname" style="font-weight:500;" class="col-form-label">Name of Block Coordinator</label>
			<input type="text" name="finalpresidentsec_name" value="<?php echo $finalpresidentsec_name; ?>" class="form-control col-md-8" id="inputname"></div> <br/>
			</div><br/>
			...
			<input type="text" name="finalblockcoordinator" value="<?php echo $finalblockcoordinator; ?>" class="form-control col-md-8" id="inputname"></div><br/>
			</div>
			
			<div class="col-md-12">
			<div class="form-group col-md-12 row"><label for="inputname" style="font-weight:500;" >Date: *&nbsp;&nbsp;</label>
			<input type="date" name="finaldate" value="<?php echo $finaldate; ?>" class="form-control col-md-5" id="inputname"></div><br/>
			</div>

			<div class="col-md-12">
			<div class="form-group col-md-12 row"><label for="inputname" style="font-weight:500;" >Place:&nbsp;&nbsp;&nbsp;</label>
			<input type="text" name="finalplace" value="<?php echo $finalplace; ?>" class="form-control col-md-5" id="inputname"></div>
			</div>				
