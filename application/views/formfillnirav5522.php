	...
	<div class="container-fluid">
      ...
      <div>
			  ...
			  <tbody>
				<tr>
				 ...
				 <td class="col-md-2 px-2 text-center">
				  ...
				  <option value="">No</option>
					<option value="Minutes of the Meeting Book" <?php echo (stristr($BOR,'Minutes of the Meeting Book') == true ?'selected="selected"':''); ?>>Yes</option>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Bank Book for all transactions*</td>
				  ...
				  <select class="form-control  col-md-7" name="bor[]">
				  <option value="">No</option>
					<option value="Bank Book for all transactions" <?php echo (stristr($BOR,'Bank Book for all transactions') == true )?'selected="selected"':''; ?>>Yes</option>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Purchase Sale and Stock Register*</td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="bor[]">
					<option value="Purchase Sale and Stock Register" <?php echo (stristr($BOR,'Purchase Sale and Stock Register') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="">No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Bill Book and Receipt Book*</td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="bor[]">
					<option value="Bill Book and Receipt Book" <?php echo (stristr($BOR,'Bill Book and Receipt Book') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="">No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Doule Entry Cash Book*</td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="bor[]">
					<option value="Doule Entry Cash Book" <?php echo (stristr($BOR,'Doule Entry Cash Book') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="">No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Loan Ledger*</td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="bor[]">
					<option value="Loan Ledger" <?php echo (stristr($BOR,'Loan Ledger') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="">No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <input type="text" class="form-control col-md-4"    ></p></td> </td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="bor[]" onchange='CheckValue(this.value);'>
			  ...
			  <tbody>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Pashu Pathshala</td>
				   <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					<option value="Pashu Pathshala" <?php echo (stristr($TLAgriculture,'Pashu Pathshala') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLAgriculture,'Pashu Pathshala') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Land preparation,ploughing,Tractorisation/Manual</td>
				   <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					<option value="Land preparation,ploughing" <?php echo (stristr($TLAgriculture,'Land preparation,ploughing') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLAgriculture,'Land preparation,ploughing') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Soil Nutrients Management</td>
				   <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					<option value="Soil Nutrients Management" <?php echo (stristr($TLAgriculture,'Soil Nutrients Management') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLAgriculture,'Soil Nutrients Management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Pest Management</td>
				   <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					<option value="Pest Management" <?php echo (stristr($TLAgriculture,'Pest Management') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLAgriculture,'Pest Management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Irrigation</td>
				   <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					<option value="Irrigation" <?php echo (stristr($TLAgriculture,'Irrigation') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLAgriculture,'Irrigation') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Bund formation,uprooting of weeds interculture,transplanting,harvesting,winnowing,Threeshing etc</td>
				   <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]">
					<option value="Bund formation,uprooting of weeds interculture" <?php echo (stristr($TLAgriculture,'Bund formation,uprooting of weeds interculture') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLAgriculture,'Bund formation,uprooting of weeds interculture') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
       ...
       minlength="4" maxlength="8" size="10" class="form-control"></div>
				 ...
				 <input type="text" class="form-control col-md-4"    ></p></td> </td>
				  <td class="col-md-2 px-2 text-center">
				  <select class="form-control  col-md-7" name="TLAgriculture[]" onchange='CheckValuesssss(this.value);'>
			...
			<?php } ?>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Integrated Nutrient Management</td>
				   <td class="col-md-2 px-2 text-center">
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					<option value="Integrated Nutrient Management" <?php echo (stristr($TLHorticulture,'Integrated Nutrient Management') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLHorticulture,'Integrated Nutrient Management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Integrated Pest Management</td>
				   <td class="col-md-2 px-2 text-center">
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					<option value="Integrated Pest Management" <?php echo (stristr($TLHorticulture,'Integrated Pest Management') == true ?'selected="selected"':''); ?>>Yes</option>
					<option  value="" <?php echo (stristr($TLHorticulture,'Integrated Pest Management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Post Harvest Management</td>
				   <td class="col-md-2 px-2 text-center">
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					<option value="Post Harvest Management" <?php echo (stristr($TLHorticulture,'Post Harvest Management') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLHorticulture,'Post Harvest Management') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Supply Chain Management of Horticultural crops</td>
				   <td class="col-md-2 px-2 text-center">
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					<option  value="Supply Chain Management of Horticultural crops" <?php echo (stristr($TLHorticulture,'Supply Chain Management of Horticultural crops') == true ?'selected="selected"':''); ?>>Yes</option>
					<option  value="" <?php echo (stristr($TLHorticulture,'Supply Chain Management of Horticultural crops') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Organic farming</td>
				   <td class="col-md-2 px-2 text-center">
				  <select  name="TLHorticulture[]" class="form-control  col-md-7">
					<option  value="Post Harvest Management" <?php echo (stristr($TLHorticulture,'Organic farming') == true ?'selected="selected"':''); ?>>Yes</option>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Cultivation and management of commercial horticulture crops</td>
				   <td class="col-md-2 px-2 text-center">
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					<option  value="Cultivation and management of commercial horticulture crops" <?php echo (stristr($TLHorticulture,'Cultivation and management of commercial horticulture crops') == true ?'selected="selected"':''); ?>>Yes</option>
					<option  value="" <?php echo (stristr($TLHorticulture,'Cultivation and management of commercial horticulture crops') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
				...
				<tr>
				 ...
				 <td style="font-weight:500;">Marketing </td>
				   <td class="col-md-2 px-2 text-center">
				  <select name="TLHorticulture[]" class="form-control  col-md-7">
					<option value="Marketing" <?php echo (stristr($TLHorticulture,'Marketing') == true ?'selected="selected"':''); ?>>Yes</option>
					<option value="" <?php echo (stristr($TLHorticulture,'Marketing') == false ?'selected="selected"':''); ?>>No</option>
				  </select>
				  </td>
				</tr>
   ...
   element.style.display='none';
       ...
       minlength="4" maxlength="8" size="10" class="form-control"></div>
		   ...
		   <form class="row pr-4 pl-4" method="post">
			...
			<input type="number" name="su_paymenttomember" value="<?php echo $su_paymenttomember; ?>" class="form-control col-md-8" min="0" id="inputname"></div>
			<br/>
			<div class="form-group">
			...
			<div class="col-md-12">
			   ...
			   <!--div class="col-md-2">
				...
				<div class="col-md-3">
			     ...
			     <div class="form-check">
					<input class="form-check-input addtnalact"  name="su_reinvesttopg" type="radio" id="gridCheck1" onclick="enabletxtinvertopg('inputadditionalactothers1')"  <?php echo ($su_reinvesttopg == '')?'':'checked'; ?>>
					<label class="form-check-label" for="gridCheck1" >
					 Infrastructure
					</label>
					<div class="form-group col-md-2" style="display:<?php if($this->uri->segment(2) == true){ if($pgdetail[0]['su_reinvesttopg'] != 'Infrastructure') {  echo 'block'; } }else {  echo 'none'; } ?>;" id="inputadditionalactothers1"  >
					<input type="text"   name="su_reinvesttopg" class="form-control" value="<?php echo $su_reinvesttopg ; ?>" <?php echo ($su_reinvesttopg == '')?'hidden':''; ?>>
					</div>
				  </div>
				  
				  <div class="form-check">
					<input class="form-check-input addtnalact" name="su_reinvesttopg"  type="radio" id="gridCheck1" onclick="enabletxtinvertopg('inputadditionalactothers2')"  <?php echo ($su_reinvesttopg == '')?'':'checked'; ?>>
					<label class="form-check-label" for="gridCheck1">
					 Idle
					</label>
					<div class="form-group col-md-2" style="display:none;" id="inputadditionalactothers2" >
					<input type="text" class="form-control" name="su_reinvesttopg" value="<?php echo $su_reinvesttopg ; ?>" <?php echo ($su_reinvesttopg == '')?'hidden':''; ?>>
					</div>
				  </div>
				  
				  <div class="form-check">
					<input class="form-check-input addtnalact" name="su_reinvesttopg"   type="radio" id="gridCheck1" onclick="enabletxtinvertopg('inputadditionalactothers3')" <?php echo ($su_reinvesttopg == '')?'':'checked'; ?>>
					<label class="form-check-label" for="gridCheck1">
					 Others
					</label>
		  ...
		  <form class="row pr-4 pl-4" method="post">
			  ...
			  <tbody>
				<tr>
				  <td><input class="form-control" name="cb_cihcb" value="<?php echo $cb_cihcb; ?>" type="text" placeholder=" "></td>
				  <td><input class="form-control" name="cb_cihbb" value="<?php echo $cb_cihbb; ?>" type="text" placeholder=" "></td>				 
				  <td><input class="form-control" name="cb_total" value="<?php echo $cb_total; ?>" type="text" placeholder=" "></td>
				</tr>
