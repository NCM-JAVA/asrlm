					...
					<div class="content content-box">
						<!-- <div class="col-md-12 text-right mb-1 pt-3 pb-3"> -->
							...
							<!-- <button class="btn btn-success" type="button" name="addpg" value="Add PG"
								onclick="window.location.href='<?php echo base_url() ?>pg-profile'">Add PG</button> -->
						<!-- </div> -->
						...
						<form class="row pr-4 pl-4" id="frmbasicdetails" method="post">
							<div class="col-md-12 row mt-4">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="pgname" placeholder="Enter PG Name" required />
							...
							<div class="col-md-12 row mt-4">
								<div class="col-md-3">
									<h6 class="m-0"> CLF Name*</h6>
								</div>
								<div class="col-md-9">
									<input type="text" class="form-control" name="clf" placeholder="Enter CLF Name" required />
								</div>
							</div>
							<div class="col-md-12 row mt-4">
								<div class="col-md-3">
									<h6 class="m-0"> Model CLF*</h6>
								</div>
								<div class="col-md-9">
									<select name="clf_model" class="form-control">
							...
							<div class="col-md-12 row mt-4">
								...
								<div class="col-md-9">
									<div class="input-group">
										...
										<input type="date" class="form-control" name="dof" placeholder="dd-mm-yyyy"
			...
			<div class="row mt-5">
				...
				<div class="col-md-10">
					<div class="content content-box">
						...
						<form class="row pr-4 pl-4" action="<?php echo base_url() . 'pg-profile/3'; ?>" method="post">
		...
		<div class="row mt-5">
			...
			<div class="col-md-10">
				<div class="content content-box">
								...
								<div class="col-md-6" id="pashusakhipgga">
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="preparation_of_calendar_for_vaccination_and_deworming" <?php echo (stristr($VAAPS, 'preparation_of_calendar_for_vaccination_and_deworming') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Preparation of Calendar for Vaccination & Deworming
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="guidance_on_housing_of_livestock" <?php echo (stristr($VAAPS, 'guidance_on_housing_of_livestock') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Guidance on Housing of Livestock
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="guidance_on_feeding_of_animals" <?php echo (stristr($VAAPS, 'guidance_on_feeding_of_animals') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Guidance on Feeding of Animals
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="hygiene_and_sanitation_of_animals" <?php echo (stristr($VAAPS, 'hygiene_and_sanitation_of_animals') == true ? 'checked' : ''); ?> id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Hygiene and Sanitation of Animals
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="deworming" <?php echo (stristr($VAAPS, 'deworming') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Deworming
										</label>
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="castration" <?php echo (stristr($VAAPS, 'castration') == true ? 'checked' : ''); ?> id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Castration
										</label>
									</div>
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="artificial_insemination" <?php echo (stristr($VAAPS, 'artificial_insemination') == true ? 'checked' : ''); ?> id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="vaccination_camp" <?php echo (stristr($VAAPS, 'vaccination_camp') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Vaccination Camp
										</label>
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="incubation_and_brooding_in_poultry" <?php echo (stristr($VAAPS, 'incubation_and_brooding_in_poultry') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
                   ...
                   <div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="psaa[]"
											value="hay_making_and_silage_making" <?php echo (stristr($VAAPS, 'hay_making_and_silage_making') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Hay Making & Silage Making
										</label>
									</div>
								...
								<div class="col-md-6" id="krishisakhipgga"> <br />
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="preparation_of_seasonal_calendar" <?php echo (stristr($VAAKS, 'preparation_of_seasonal_calendar ') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Preparation of Seasonal Calendar 
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="seed_sorting_practices" <?php echo (stristr($VAAKS, 'seed_sorting_practices') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Seed sorting practices
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="seed_treatment" <?php echo (stristr($VAAKS, 'seed_treatment ') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Seed Treatment 
										</label>
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="soil_testing" <?php echo (stristr($VAAKS, 'soil_testing') == true ? 'checked' : ''); ?> id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Soil Testing (To provide Soil Health Card to Farmers)
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="seed_preservation_practice" <?php echo (stristr($VAAKS, 'seed_preservation_practice') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="nursery_bed_raising" <?php echo (stristr($VAAKS, 'nursery_bed_raising') == true ? 'checked' : ''); ?> id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Nursery Bed Raising
										</label>
									</div>
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="system_of_rice_intensification" <?php echo (stristr($VAAKS, 'system_of_rice_intensification ') == true ? 'checked' : ''); ?> id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
									...
									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="field_preparation_through_green_manuring" <?php echo (stristr($VAAKS, 'field_preparation_through_green_manuring') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Field Preparation Through Green Manuring
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="preparation_of_organic_nutrients" <?php echo (stristr($VAAKS, 'preparation_of_organic_nutrients') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Preparation of Organic Nutrients (Per Nutrient)
										</label>
									</div>
                                     
                  <div class="form-check">
										<input class="form-check-input addtnalact" type="checkbox" name="ksaa[]"
											value="preparation_of_organic_pesticide_fungicide_weedicide" <?php echo (stristr($VAAKS, 'preparation_of_organic_pesticide_fungicide_weedicide') == true ? 'checked' : ''); ?>
											id="gridCheck1">
										<label class="form-check-label" for="gridCheck1">
											Preparation of Organic Pesticide/Fungicide/Weedicide, etc (For each type of Pesticide /Fungicide/Weedicide)
										</label>
									</div>
					...
					<form class="pr-4 pl-4" method="post">
						...
						<div class="row">
							...
							<div class="col-md-12 text-right mb-1">
								<a class="btn btn-primary" onclick="javascript:history.back()"
									style="color:#fff;">Previous</a>
								<input type="hidden" name="stepno13" value="13">
								<input type="hidden" name="isedit" value="1">
								<input type="submit" class="btn btn-primary" style="background:#2B78E4;" name="submit1" value="Submit">
								<!-- <button class="btn btn-primary" type="button" name="submit" value="submit1"
