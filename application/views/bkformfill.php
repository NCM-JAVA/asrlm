	...
	<div class="container-fluid">
		<div class="row list-view">
			...
			<div class="col-md-2">
				<div class="sidebar">
					...
					?>
					<?php if($user_data['user_group_id'] == 3){ ?>
						<ul>
					...
					<?php } else if($user_data['user_group_id'] == 1){ ?>
						<ul>
							<li><a href="<?php echo base_url(); ?>user-profile" class="<?php echo ($current_segment == 'user-profile') ? 'active' : ''; ?>">Profile</a></li>
							<li><a href="<?php echo base_url(); ?>verifierpanel" class="<?php echo ($current_segment == 'verifierpanel') ? 'active' : ''; ?>">Verifier Panel</a></li>
							<li><a href="<?php echo base_url(); ?>login/logout">Logout</a></li>
						</ul>
					<?php } else if($user_data['user_group_id'] == 2){ ?>
						<ul>
							<li><a href="<?php echo base_url(); ?>user-profile" class="<?php echo ($current_segment == 'user-profile') ? 'active' : ''; ?>">Profile</a></li>
							<li><a href="<?php echo base_url(); ?>approverpanel" class="<?php echo ($current_segment == 'approverpanel') ? 'active' : ''; ?>">Approver Panel</a></li>
							<li><a href="<?php echo base_url(); ?>login/logout">Logout</a></li>
						</ul>
					<?php } else if($user_data['user_group_id'] == 4) { ?>
						<ul>
							<li><a href="<?php echo base_url(); ?>user-profile" class="active">Profile</a></li>
							<li><a href="<?php echo base_url(); ?>login/logout">Logout</a></li>
						</ul>
					<?php } else { ?>
						<ul>
      ...
      <div>
		...
		<label class="btn btn-primary"  id="crplabel"  style="margin-right: 14px;font-weight: 500;"><input type="checkbox" id="crpcheckbox"  name="uspgtype[]" onclick="pgaddionalresponse('crpcheckbox','crppg','crplabel')" value="crppg">&nbsp;CRP</label>
			 ...
			 <div class="red box">Name of Udyog Sakhi Associated with the PG</div>
				<div class="col-md-4">
				  <div class="form-check">
				  ...
				  <label class="form-check-label" for="exampleRadios1">
				   ...
				   <div class="form-group col-md-7 px-0">
					<input type="text" class="form-control" id="inputothers">
					</div>
				  </div>
				</div>
			   ...
			   <div class="form-group row">
			   <label for="inputvallueaadion" class="col-form-label col-md-4">No. of Village Covered by PG</label>
			     <div class="form-group col-md-7 px-0">
			   ...
			   <div class="form-group row">
			   <label for="inputvallueaadion" class="col-form-label col-md-4">No. of Member Associated with PG</label>
			      <div class="form-group col-md-7 px-0">
					<select class="form-control col-md-2">
					<option>1</option>
					<option>2</option>
			   ...
			   <div class="form-group row">
			   <label for="inputvallueaadion" class="col-form-label col-md-4">No. of Participants in PG</label>
			     <div class="form-group col-md-7 px-0">
					<select class="form-control col-md-2">
					<option>1</option>
					<option>2</option>
			...
			<div id="pashusakhipg" style="display:none">
             ...
             <div class="form-group col-md-12 row">
			 <div class="red box">Name of Pashu Sakhi Associated with the PG</div>
			...
			<div id="krishisakhipg" style="display:none">
             ...
             <div class="form-group col-md-12 row">
			 <div class="red box">Name of Krishi Sakhi Associated with the PG</div>
			...
			<div id="crppg" style="display:none">
             ...
             <div class="form-group col-md-12 row">
			 <div class="red box">Name of CRP Associated with the PG</div>
			   ...
			   <label for="inputvallueaadion" class="col-form-label col-md-4">No. of Participants in PG</label>
				...
				<button class="btn btn-primary" type="button" name="submit" value="Signup" onclick="window.location='<?php echo base_url().'form-filling/4'; ?>'">Next</button>
				</div>				  
			</form>			
         ...
         <div class="col-md-12">
		   ...
		   <form class="row pr-4 pl-4" method="post">
			  ...
			  <tbody>
				<tr>
				  ...
				  <div class="col-md-6"> <input class="form-control" type="text" placeholder="Quantity"  ></div>
				   </div>
				  </td>
				</tr>
		   ...
		   <form class="row pr-4 pl-4" method="post">
			...
			<div class="form-group col-md-12 row"><label for="inputname" style="font-weight:500;" >Re Invest to PG: &nbsp;&nbsp;</label><div class="col-md-12">
				  ...
				  <div class="form-check">
					<input class="form-check-input addtnalact" type="radio" id="gridCheck1">
					<label class="form-check-label" for="gridCheck1">
					 Infrastructure
					</label>
