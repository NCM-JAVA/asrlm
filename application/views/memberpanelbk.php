	...
	<div class="container-fluid">
		<div class="row list-view">
		   ...
		   <h6 class="m-0">Name*</h6>
			...
			<input type="text" class="form-control col-md-6"  placeholder="Name*" required />
			 </div>
		   </div>
		   </div>
		   ...
		   <h6 class="m-0">SHG Name*</h6>
		    ...
		    <div class="col-md-9">
			<div class="input-group">			 
			<input type="text"  class="form-control col-md-6"  placeholder="SHG Name*" required />
			 </div>
		   </div>
		   </div>
		    <div class="col-md-12 row mt-4">
		   ...
		   <h6 class="m-0">SHG Code*</h6>
		    ...
		    <div class="col-md-9">
			<div class="input-group">			 
			<input type="text"  class="form-control col-md-2"  placeholder="SHG Code*" required />
			 </div>
		   </div>
		   </div>
		   <div class="col-md-12 row mt-4">
		   ...
		   <h6 class="m-0">Location*</h6>
		    ...
		    <div class="col-md-9">
			  <div class="form-row">
				...
				<div class="col-md-3 mb-3">
				  <label for="validationTooltip04"><b>Village Name</b></label>
				  <select class="custom-select" id="validationTooltip04" required>
					<option selected disabled value="">Choose...</option>
					<option>Bajrajhar</option>
					<option>Daigola</option>
					<option>Bhogdal</option>
					<option>Mahaliapara</option>
				  </select>
				  <div class="invalid-tooltip">
					Please select a valid Block.
				  </div>
		   ...
		   <h6 class="m-0">Name of the Husband / Father of Women Member*</h6>
		    ...
		    <div class="col-md-9">
			<div class="input-group">			 
			<input type="text" class="form-control col-md-6"  Details  placeholder=" Husband / Father of Women Member* " 
 required />
			 </div>
		   </div>
		   </div>
		   ...
		   <h6 class="m-0">Contact No*</h6>
			...
			<input type="tel" class="form-control col-md-6" placeholder=" Contact No*" maxlength="10" required />
		   ...
		   <h6 class="m-0"> Identity Document* </h6>
			...
			<div class="input-group">			 
			<div class="input-group">			 
				<select class="form-control col-md-2" onchange="getfisheryoptions(this.value)">
		   ...
		   <h6 class="m-0">Membership Type*</h6>
		    ...
		    <div class="col-md-9">
			<div class="input-group">			 
			<input type="text" class="form-control col-md-6" placeholder=" Membership Type*"  required />
				  <div class="invalid-tooltip">
					Please provide a valid zip.
				  </div>
			 </div>
		    ...
		    <div class="col-md-12 text-right mb-1"><br/>
				<button class="btn btn-primary" type="submit" name="submit" value="Signup" onclick="window.location='<?php echo base_url().'memberpanel/2'; ?>'">Next</button>
		    </div>				
			</form>
			</div>
			</div>
