			...
			<div class="row form-row">
				...
				<div class="input-text-box col-md-6">
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" id="sel1" placeholder="Data Entry" readonly />
				...
				<div class="input-text-box col-md-6">
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" name="organization" id="sel1" value="ASRLM" readonly />
					</div>
