<div class="sidebar">
    ...
    <ul>
        ...
        <?php if($this->session->userdata('admin_session')['user_group_id'] == '3' || $this->session->userdata('admin_session')['user_group_id'] == '13'){ ?> 
        ...
        <?php if($this->session->userdata('admin_session')['user_group_id'] == '3' || $this->session->userdata('admin_session')['user_group_id'] == '13'){ ?> 
            ...
            <li><a href="<?php echo base_url(); ?>register" class="<?php echo ($current_segment == 'approverpanel') ? 'active' : ''; ?>">User Registration</a></li>
