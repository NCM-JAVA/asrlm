...
<?php //print_r($this->session->admin_session['name']);

if($this->session->admin_session == true){  ?>
  <span style="color:#fff;font-weight:600;position: relative;top: -2px;">Hi </span> <h6  style="color:#fff;">  <a href="<?php echo base_url()?>user-profile" style=" padding: 0px 4px;background:transparent;" title="<?php echo $this->session->admin_session['name']; ?>"><?php echo $this->session->admin_session['name']; ?>! </a> | <a href="<?php echo base_url()?>login/logout" style="float: right;padding: 0px 5px;background:transparent;">  Logout </a></h6> 
...
<div class="col-md-2 text-center"> 
	...
	?>
        ...
        <h3><?php echo count(array_unique(explode(', ',$strcommodity)));
		//echo $commoditylists2; ?></h3>
    </div>
</div>
<div class="col-md-2 text-center">
    <div class="infoboxtop card">
