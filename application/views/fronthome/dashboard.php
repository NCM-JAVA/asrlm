                ...
                <div class="col-md-2">
                    <div class="">
                        <a href="<?php echo base_url(); ?>" class="col-md-7 logo">
                            <img src="<?php echo base_url(); ?>/images/ASRLMS-Logo-Transparent-English.png"
                                style="max-height: 71px; border-radius: 5px;" alt="Logo" />
                        </a>
                    </div>
                </div>
                            ...
                            <div class="input-group mt-4 mb-3">
                                <select class="custom-select" id="districtname" name="districtname">
                                    ...
                                    <?php foreach ($districts as $district) { ?>
                                        ...
                                        <option value="<?php echo $district['district']; ?>" <?php if ($district['district'] == $this->input->get('districtname')) {
                                               echo 'selected="selected"';
                                           } ?>><?php echo ucfirst($district['district']); ?>
                                        </option>
                        ...
                        <div class="col-md-4" style="margin-top: 23px;">
                            <div class="input-group mt-4 mb-3">
                                <select class="custom-select" id="blocknames" name="blockname">
                                    ...
                                    <option value="<?php echo $this->input->get('blockname'); ?>" <?php if ($this->input->get('blockname') == true) {
                                           echo 'selected="selected"';
                                       } ?>>
                                        <?php echo ucfirst($this->input->get('blockname')); ?>
                                    </option>
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-2 text-center">
                <div class="infoboxtop card">
                    <h6>
                        <a href="#" title="<?php echo $districtnames; ?>">Districts&nbsp;<i class="fa fa-caret-down"
                                aria-hidden="true" style="color:#17C672;"></i></a>
                    </h6>
                    <h3><?php echo count($districts1) ?></h3>
                </div>
            </div>
            <div class="col-md-2 text-center">
                <div class="infoboxtop card">
                    <h6><a href="#" title="<?php echo $blocknames; ?>">Blocks&nbsp;<i class="fa fa-caret-down"
                                aria-hidden="true" style="color:#17C672;"></i></a></h6>
                    <h3><?php echo count($blocks) ?></h3>
                </div>
            </div>
            <div class="col-md-2 text-center">
                <div class="infoboxtop card">
                    <h6><a href="#" title="<?php echo $pgnames; ?>">Producer Groups&nbsp;<i class="fa fa-caret-down"
                                aria-hidden="true" style="color:#17C672;"></i></a></h6>
            ...
            <div class="col-md-2 text-center">
                <div class="infoboxtop card">
                    <h6><a href="#" title="<?php echo count($pgmembers); ?>">PG Members&nbsp;<i class="fa fa-caret-down"
                                aria-hidden="true" style="color:#17C672;"></i></a></h6>
            ...
            <div class="col-md-2 text-center">
                <div class="infoboxtop card">
                    ...
                    ?>
                    <h6><a href="#" title="<?php echo strtoupper($strcommodity); ?>">Commodities&nbsp;<i
                                class="fa fa-caret-down" aria-hidden="true" style="color:#17C672;"></i></a></h6>
                    <h3><?php echo count(array_unique(explode(', ', $strcommodity))); ?></h3>
                </div>
            </div>
            <div class="col-md-2 text-center">
                <div class="infoboxtop card">
                    <h6><a href="#"
                            title="<?php echo 'Drying, Grading, Sorting, Processing, Storing, Packaging, Labelling, Weighing, Collective marketing, Others, None of The Above'; ?>">Value
                            Addition&nbsp;<i class="fa fa-caret-down" aria-hidden="true" style="color:#17C672;"></i></a>
                    </h6>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="small-box bg-info">
                    <div class="inner">
                        <h3>0 <sup style="font-size: 18px">Ton</sup> </h3>

                        <p>Agriculture</p>

                    </div>
                    <div class="icon">
                        <img style="max-width: 45px;position: absolute;top: 21px;right: 13px;/* background: rgba(0,0,0,0.6); */background: #148A9D;padding: 5px;border-radius: 5px;"
                            src="<?php echo base_url() . 'images/paddy.png' ?>">
                    </div>
            ...
            <div class="col-md-2">
                ...
                <div class="small-box bg-success">
                    <div class="inner" style="color:#fff;">
                        <h3>0<sup style="font-size: 18px">Kg</sup></h3>

                        <p>Horticulture</p>
                    </div>
                    <div class="icon">
                        <img style="max-width:45px;position: absolute;top: 21px;right: 13px;background: #228E3B;padding: 5px;border-radius: 5px;"
                            src="<?php echo base_url() . 'images/fruits.png' ?>">
                    </div>
                    <!-- <a href="#" class="small-box-footer">More info <i class="fa fa-sort-desc" aria-hidden="true"></i></a> -->
                </div>
            </div>
            ...
            <div class="col-md-2">
                ...
                <div class="small-box bg-warning">
                    <div class="inner" style="color:#fff;">
                        <?php if ($this->input->get('districtname') == 'nagaon' || $this->input->get('districtname') == '') { ?>
                            <h3>150<sup style="font-size: 18px">Nos.</sup></h3>
                        <?php } else { ?>
                            <h3>0<sup style="font-size: 18px">Nos.</sup></h3>
                        <?php } ?>
                        <p>Livestocks</p>
                    </div>
                    <div class="icon">
                        <img style="max-width:45px;min-height:44px;position: absolute;top: 21px;right: 13px;background:#D9A406;padding: 5px;border-radius: 5px;"
                            src="<?php echo base_url() . 'images/pig.png' ?>"> <!--i class="ion ion-person-add"></i-->
                    </div>
                    <!-- <a href="#" class="small-box-footer">More info <i class="fa fa-sort-desc" aria-hidden="true"></i></a> -->
                </div>
            </div>
            ...
            <div class="col-md-2">
                ...
                <div class="small-box bg-danger">
                    ...
                    <div class="icon">
                        <img style="max-width:45px;min-height:44px;position: absolute;top: 21px;right: 13px;background:#BB2D3B;padding: 5px;border-radius: 5px;"
                            src="<?php echo base_url() . 'images/fish.png' ?>">
                        <!--i class="ion ion-person-add"></i--><!--i class="ion ion-pie-graph"></i-->
                    </div>
                    <!-- <a href="#" class="small-box-footer">More info <i class="fa fa-sort-desc" aria-hidden="true"></i></a> -->
                </div>
            </div>
            <div class="col-md-2">
                ...
                <div class="small-box bg-info">
                    ...
                    <div class="icon">
                        <img style="max-width:45px;min-height:44px;position: absolute;top: 21px;right: 13px;background:#148A9D;padding: 5px;border-radius: 5px;"
                            src="<?php echo base_url() . 'images/silkwarm.png' ?>">
                        <!--i class="ion ion-person-add"></i--><!--i class="ion ion-pie-graph"></i-->
        ...
        composition or comparison of All Commodity. 
            ...
            <div class="col-md-6">
                ...
                <figure class="highcharts-figure">
                    ...
                    <!--p class="highcharts-description">
        This chart may vary for showing a compact overview of a
        composition or comparison of Livestocks. 
    </p-->
                </figure>
            </div>
    ...
    <script>
        ...
        Highcharts.chart('commodityvsblock', {
                ...
                events: {
                    drilldown: function (e) {
                        if (!e.seriesOptions) {
                            ...
                            var chart = this,
                                drilldowns = {
                                    <?php echo ucfirst($totalcommodata[0]['name']) ?>: {
                                        name: "<?php echo ucfirst($totalcommodata[0]['name']) ?>",
                                        data: [
                                    ...
                                    <?php echo ucfirst($totalcommodata[1]['name']) ?>: {
                                        name: "<?php echo ucfirst($totalcommodata[1]['name']) ?>",
                                        data: [
                                    ...
                                    <?php echo ucfirst($totalcommodata[2]['name']) ?>: {
                                        name: "<?php echo ucfirst($totalcommodata[2]['name']) ?>",
                                        data: [
                                    ...
                                    <?php echo ucfirst($totalcommodata[3]['name']) ?>: {
                                        name: "<?php echo ucfirst($totalcommodata[3]['name']) ?>",
                                        data: [
                                    ...
                                    <?php echo ucfirst($totalcommodata[4]['name']) ?>: {
                                        name: "<?php echo ucfirst($totalcommodata[4]['name']) ?>",
                                        data: [
                                    ...
                                    <?php echo ucfirst($totalcommodata[5]['name']) ?>: {
                                        name: "<?php echo ucfirst($totalcommodata[5]['name']) ?>",
                                        data: [
                                    ...
                                    <?php echo ucfirst($totalcommodata[6]['name']) ?>: {
                                        name: "<?php echo ucfirst($totalcommodata[6]['name']) ?>",
                                        data: [
            ...
            series: [{
                ...
                data: [{
                    name: "<?php echo ucfirst($totalcommodata[0]['name']) ?>",
                    y: <?php echo ucfirst($totalcommodata[0]['count']) ?>,
                    drilldown: false
                }, {
                    name: "<?php echo ucfirst($totalcommodata[1]['name']) ?>",
                    y: <?php echo ucfirst($totalcommodata[1]['count']) ?>,
                    drilldown: false
                }, {
                    name: "<?php echo ucfirst($totalcommodata[2]['name']) ?>",
                    y: <?php echo ucfirst($totalcommodata[2]['count']) ?>,
                    drilldown: false
                }, {
                    name: "<?php echo ucfirst($totalcommodata[3]['name']) ?>",
                    y: <?php echo ucfirst($totalcommodata[3]['count']) ?>,
                    drilldown: false
                }, {
                    name: "<?php echo ucfirst($totalcommodata[4]['name']) ?>",
                    y: <?php echo ucfirst($totalcommodata[4]['count']) ?>,
                    drilldown: false
                }, {
                    name: "<?php echo ucfirst($totalcommodata[5]['name']) ?>",
                    y: <?php echo ucfirst($totalcommodata[5]['count']) ?>,
                    drilldown: false
                },
                {
                    name: "<?php echo ucfirst($totalcommodata[6]['name']) ?>",
                    y: <?php echo ucfirst($totalcommodata[6]['count']) ?>,
                    drilldown: false
                },]
            }],
